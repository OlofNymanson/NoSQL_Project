...
public class Initializer {
	...
	public void initMembers() {
		...
		collection.insert(new BasicDBObject("fName", "Oscar").append("lName", "Ågren").append("address", "London").append("SSN", "19930909").append("Ocupation", "Systemutvecklare").append("coffeeCount", 0));
		collection.insert(new BasicDBObject("fName", "Göran").append("lName", "Åkesson").append("address", "Malmö").append("SSN", "19931009").append("Ocupation", "Systemutvecklare").append("coffeeCount", 0));
		collection.insert(new BasicDBObject("fName", "Nils").append("lName", "Malmgren").append("address", "Malmö").append("SSN", "19940909").append("Ocupation", "Systemutvecklare").append("coffeeCount", 0));
		collection.insert(new BasicDBObject("fName", "Max").append("lName", "Hermansson").append("address", "Amsterdam").append("SSN", "19900129").append("Ocupation", "Snickare").append("coffeeCount", 0));
		collection.insert(new BasicDBObject("fName", "Jonatan").append("lName", "Viro").append("address", "Örebro").append("SSN", "19911231").append("Ocupation", "Systemutvecklare").append("coffeeCount", 0));
		collection.insert(new BasicDBObject("fName", "Olof").append("lName", "Nymanson").append("address", "Pisa").append("SSN", "19991212").append("Ocupation", "Systemutvecklare").append("coffeeCount", 0));
